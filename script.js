function createGame(player1, hour, player2){
  return`
    <li>
      <img src="/icons/icon=${player1}.svg" alt="Bandeira ${player1}">
      <strong>${hour}</strong>
...
document.querySelector("#cards").innerHTML = 
    ...
    +createGame('germany','10:00','japan')+createGame('spain','13:00','costa rica')+createGame('belgium','16:00','canada'))
    ...
    +createCard('28/11','segunda',createGame('cameroon','07:00','serbia')+createGame('south korea','10:00','ghana')+createGame('brazil','10:00','switzerland')+createGame('portugal','16:00','uruguay'))
    
    +createCard('29/11','terça',createGame('netherlands','12:00','qatar')+createGame('ecuador','12:00','senegal')+createGame('wales','16:00','england')+createGame('iran','16:00','united states'))
    ...
    +createCard('02/12','sexta',createGame('ghana','12:00','uruguay')+createGame('south korea','12:00','portugal')+createGame('serbia','16:00','switzerland')+createGame('cameroon','16:00','brazil'))
